...
This command has no built-in mechanism to load a reference file automatically (unlike a Skill,
which the Skill tool loads progressively) - use the Read tool on the full path below only when
the active mode actually needs that detail:

| Topic | Reference | Load When |
| ------- | ----------- | ----------- |
| Assumption Types & Tiers | `~/.claude/commands/common-ground/references/assumption-classification.md` | Classifying assumptions, determining type or tier |
| File Management | `~/.claude/commands/common-ground/references/file-management.md` | Storage operations, project ID, ground file format |
| Reasoning Graph | `~/.claude/commands/common-ground/references/reasoning-graph.md` | Using --graph flag, generating mermaid diagrams |
...
2. **Classify each assumption** by type and proposed tier:
   - Read `~/.claude/commands/common-ground/references/assumption-classification.md` for classification rules
...
4. **Write ground file:**
   ...
   - Read `~/.claude/commands/common-ground/references/file-management.md` for file formats
...
3. **Generate mermaid diagram** following conventions in `~/.claude/commands/common-ground/references/reasoning-graph.md`
...
Read `~/.claude/commands/common-ground/references/reasoning-graph.md` for detailed mermaid conventions and node styling.
...
Adapted from [jeffallan/claude-skills](https://github.com/jeffallan/claude-skills). License terms in `common-ground/LICENSE.txt`.
