---
name: ml-pipeline
description: "Use when building ML pipelines, orchestrating training workflows, automating model lifecycle, implementing feature stores, managing experiment tracking systems, setting up DVC for data versioning, tuning hyperparameters, or configuring MLOps tooling like Kubeflow, Airflow, MLflow, or Prefect. Invoke for experiment tracking with MLflow or Weights & Biases, Kubeflow/Airflow training DAGs, Feast feature store schemas, model registries, or retraining and validation workflows."
