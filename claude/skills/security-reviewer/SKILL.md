...
description: Use when conducting security audits, reviewing code for vulnerabilities, or analyzing infrastructure security. Invoke for SAST scans, penetration testing, DevSecOps practices, cloud security reviews, dependency audits, secrets scanning, or compliance checks.
...
2. **Scan** - Run SAST, dependency, and secrets tools. Example commands:
   ...
   - `trivy fs .`
3. **Review** - Manual review of auth, input handling, and crypto. Automated tools miss context, so manual review is mandatory.
