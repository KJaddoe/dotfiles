...
class ErrorBudget:
    ...
    def remaining_budget(self, actual_sli: float) -> float:
        ...
        Args:
            actual_sli: Measured SLI value (0.0 to 1.0)
...
class ErrorBudgetCalculator:
    ...
    def calculate_budget_status(
        ...
        Args:
            good_events: Count of events that met the SLI
            total_events: Count of all measured events
...
def should_deploy(
    ...
    Args:
        budget_remaining: Fraction of error budget remaining (0.0 to 1.0)
        change_risk: Risk level of the change ('low', 'medium', 'high')
        business_priority: Priority of the change ('low', 'medium', 'high', 'critical')
