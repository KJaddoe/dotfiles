---
name: swift-expert
description: Use when building iOS/macOS applications with Swift 5.9+, SwiftUI, or async/await concurrency. Invoke for protocol-oriented programming, SwiftUI state management, actors for thread safety, server-side Swift, UIKit integration, Combine, or Vapor.
