...
### FR_001: [Requirement Name]
While <precondition>, when <trigger>, the system shall <response>.

### FR_002: [Requirement Name]
While <precondition>, when <trigger>, the system shall <response>.
...
### AC_001: [Scenario Name]
Given [context/precondition]
When [action taken]
Then [expected result]

### AC_002: [Scenario Name]
Given [context/precondition]
When [action taken]
Then [expected result]
...
Save as: `{project-memory-dir}/specs/{feature_name}.spec.md`, the untracked per-project session
directory, not a `specs/` folder inside the repository.
