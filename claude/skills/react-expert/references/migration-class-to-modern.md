...
### Class Component (Constructor and State → useState)
...
### Modern React (Constructor and State → useState)
...
### Class Component (Lifecycle Methods → useEffect)
...
### Modern React (Lifecycle Methods → useEffect)
...
### Class Component (shouldComponentUpdate → React.memo)
...
### Modern React (shouldComponentUpdate → React.memo)
...
### Class Component (Complex State → useReducer)
...
### Modern React (Complex State → useReducer)
...
### Class Component (Refs Migration)
...
### Modern React with Custom Hook (HOC to Hooks)
...
### Modern React with Custom Hook (Render Props to Hooks)
...
### Class Component (Context Migration)
...
### Modern React (Context Migration)
