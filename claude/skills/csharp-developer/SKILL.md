...
- Write an XML doc block for a declaration the gate did not clear, including an obvious getter/setter or a method whose name and signature already say everything
