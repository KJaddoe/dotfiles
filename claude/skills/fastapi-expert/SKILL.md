...
- Expose the API surface through type hints, `Field` descriptions, and route metadata (auto-generated OpenAPI); write a docstring only where the Docstrings gate above says it is earned
