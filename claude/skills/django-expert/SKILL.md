...
2. **Design models** - Create models with proper fields, indexes, managers, then run `manage.py makemigrations` and `manage.py migrate`; verify schema before proceeding
