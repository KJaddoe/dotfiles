...
Project MEMORY.md, this index, and general.md are auto-injected before each tool call via
PreToolUse hook (~/.claude/hooks/pre-tool-memory.sh). Load other topic files only when relevant.
