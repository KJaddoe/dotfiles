...
| `domain/mise-migration.md` | In-progress: migrating node/python/ruby/java to mise (+uv for python tooling), then CLI-only RN Android. Done: mise/java/node/python/ruby + Brewfile cleanup. Remaining: Android CLI, RN device verify. Resume point + gotchas inside. | 2026-06-11 |
