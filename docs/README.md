...
| `nvim-lsp-navigation.md` | LSP code-navigation keymaps, why an empty result is often correct, and how discoverability is wired                                                | Changing or looking up nvim LSP navigation                  |
