...
(`qwen2.5-coder-cc:7b` / `:3b`) via Modelfiles so they load with a usable window on any
...
- The 32k window raises the 7b model's memory use to ~8 GB (fits 24 GB); a larger model or
